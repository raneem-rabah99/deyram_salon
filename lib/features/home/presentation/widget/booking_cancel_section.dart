...
import 'package:deyram_salon/features/home/presentation/widget/booking_cancel_item.dart';

class BookingCancelSection extends StatelessWidget {
  const BookingCancelSection({super.key});
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Padding(
                    ...
                    child: BookingCancelItem(bookingCancel: bookings[index]),
                  );
                },
              ),
            ),
